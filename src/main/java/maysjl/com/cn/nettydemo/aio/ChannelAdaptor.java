 ...
 * @author: May's_JL
 * @create: 2025-11-03 15:21
 **/
public abstract class ChannelAdaptor implements CompletionHandler<Integer, Object> {
    private AsynchronousSocketChannel channel;
    private Charset charset;

    public ChannelAdaptor(AsynchronousSocketChannel channel, Charset charset){
